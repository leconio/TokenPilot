-- Current empty-database baseline statement 0008.
-- Stores reduced-dimension daily partials derived only from one-minute insert blocks.
...
TTL bucket_start + toIntervalDay(1825) DELETE
